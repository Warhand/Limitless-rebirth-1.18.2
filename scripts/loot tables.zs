...
val ocean_loot as float[IItemStack] = {
	<item:aquaculture:box>                  :0.04 as float,
	<item:aquaculture:lockbox>              :0.04 as float,
	<item:aquaculture:treasure_chest>       :0.04 as float,
	<item:artifacts:antidote_vessel>        :0.04 as float,
	<item:artifacts:aqua_dashers>           :0.04 as float,
	<item:artifacts:charm_of_sinking>       :0.04 as float,
	<item:artifacts:flippers>               :0.04 as float,
	<item:artifacts:golden_hook>            :0.04 as float,
	<item:artifacts:helium_flamingo>        :0.04 as float,
	<item:artifacts:novelty_drinking_hat>   :0.04 as float,
	<item:artifacts:running_shoes>          :0.04 as float,
	<item:artifacts:snorkel>                :0.04 as float,
	<item:artifacts:umbrella>               :0.04 as float,
	<item:artifacts:whoopee_cushion>        :0.04 as float,
	<item:cyclic:charm_magicdefense>        :0.04 as float,
	<item:cyclic:charm_speed>               :0.04 as float,
	<item:cyclic:charm_starvation>          :0.04 as float,
	<item:cyclic:charm_stealthpotion>       :0.04 as float,
	<item:cyclic:charm_venom>               :0.04 as float,
	<item:cyclic:charm_water>               :0.04 as float,
	<item:cyclic:spell_water>               :0.04 as float,
	<item:minecraft:potion>                 :0.04 as float,
	<item:paraglider:spirit_orb>            :0.1 as float,
	<item:schoolsofmagic:letter_ccw>        :0.04 as float
};
...
val underground_loot as float[IItemStack] = {
	<item:aquaculture:box>                                                  :0.015 as float,
	<item:aquaculture:lockbox>                                              :0.015 as float,
	<item:aquaculture:treasure_chest>                                       :0.015 as float,
	<item:artifacts:antidote_vessel>                                        :0.015 as float,
	<item:artifacts:cross_necklace>                                         :0.015 as float,
	<item:artifacts:digging_claws>                                          :0.015 as float,
	<item:artifacts:lucky_scarf>                                            :0.015 as float,
	<item:artifacts:night_vision_goggles>                                   :0.015 as float,
	<item:artifacts:novelty_drinking_hat>                                   :0.015 as float,
	<item:artifacts:obsidian_skull>                                         :0.015 as float,
	<item:artifacts:panic_necklace>                                         :0.015 as float,
	<item:artifacts:pocket_piston>                                          :0.015 as float,
	<item:artifacts:power_glove>                                            :0.015 as float,
	<item:artifacts:running_shoes>                                          :0.015 as float,
	<item:artifacts:scarf_of_invisibility>                                  :0.015 as float,
	<item:artifacts:shock_pendant>                                          :0.015 as float,
	<item:artifacts:steadfast_spikes>                                       :0.015 as float,
	<item:artifacts:umbrella>                                               :0.015 as float,
	<item:artifacts:universal_attractor>                                    :0.015 as float,
	<item:artifacts:vampiric_glove>                                         :0.015 as float,
	<item:artifacts:whoopee_cushion>                                        :0.015 as float,
	<item:blue_skies:poison_key>                                            :0.015 as float,
	<item:cyclic:charm_antidote>                                            :0.015 as float,
	<item:cyclic:charm_attack_speed>                                        :0.015 as float,
	<item:cyclic:charm_creeper>                                             :0.015 as float,
	<item:cyclic:charm_crit>                                                :0.015 as float,
	<item:cyclic:charm_fire>                                                :0.015 as float,
	<item:cyclic:charm_invisible>                                           :0.015 as float,
	<item:cyclic:charm_knockback_resistance>                                :0.015 as float,
	<item:cyclic:charm_longfall>                                            :0.015 as float,
	<item:cyclic:charm_luck>                                                :0.015 as float,
	<item:cyclic:charm_magicdefense>                                        :0.015 as float,
	<item:cyclic:charm_speed>                                               :0.015 as float,
	<item:cyclic:charm_stealthpotion>                                       :0.015 as float,
	<item:cyclic:charm_venom>                                               :0.015 as float,
	<item:cyclic:charm_wing>                                                :0.015 as float,
	<item:cyclic:charm_world>                                               :0.015 as float,
	<item:cyclic:charm_xp_blocker>                                          :0.015 as float,
	<item:cyclic:charm_xp_speed>                                            :0.015 as float,
	<item:cyclic:crystal_pickaxe>                                           :0.015 as float,
	<item:cyclic:crystal_shovel>                                            :0.015 as float,
	<item:cyclic:crystal_sword>                                             :0.015 as float,
	<item:cyclic:ender_bag>                                                 :0.015 as float,
	<item:cyclic:ender_eye_reuse>                                           :0.015 as float,
	<item:cyclic:ender_pearl_mounted>                                       :0.015 as float,
	<item:cyclic:ender_pearl_reuse>                                         :0.015 as float,
	<item:cyclic:glove_climb>                                               :0.015 as float,
	<item:cyclic:prospector>                                                :0.015 as float,
	<item:cyclic:quiver_damage>                                             :0.015 as float,
	<item:cyclic:spawner_seeker>                                            :0.015 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string})   :0.015 as float,
	<item:paraglider:spirit_orb>                                            :0.1 as float, 
	<item:quark:diamond_heart>                                              :0.015 as float,
	<item:schoolsofmagic:letter_ccw>                                        :0.015 as float
};
...
val overworld_loot as float[IItemStack] = {
	<item:aquaculture:box>                                 :0.03 as float,
	<item:aquaculture:lockbox>                             :0.03 as float,
	<item:aquaculture:treasure_chest>                      :0.03 as float,
	<item:artifacts:bunny_hoppers>                         :0.03 as float,
	<item:artifacts:cross_necklace>                        :0.03 as float,
	<item:artifacts:helium_flamingo>                       :0.03 as float,
	<item:artifacts:kitty_slippers>                        :0.03 as float,
	<item:artifacts:novelty_drinking_hat>                  :0.03 as float,
	<item:artifacts:pocket_piston>                         :0.03 as float,
	<item:artifacts:power_glove>                           :0.03 as float,
	<item:artifacts:running_shoes>                         :0.03 as float,
	<item:artifacts:scarf_of_invisibility>                 :0.03 as float,
	<item:artifacts:thorn_pendant>                         :0.03 as float,
	<item:artifacts:umbrella>                              :0.03 as float,
	<item:artifacts:villager_hat>                          :0.03 as float,
	<item:artifacts:whoopee_cushion>                       :0.03 as float,
	<item:blue_skies:blinding_key>                         :0.03 as float,
	<item:cyclic:charm_speed>                              :0.03 as float,
	<item:cyclic:charm_stealthpotion>                      :0.03 as float,
	<item:cyclic:charm_xp_blocker>                         :0.03 as float,
	<item:cyclic:crystal_axe>                              :0.03 as float,
	<item:cyclic:crystal_hoe>                              :0.03 as float,
	<item:cyclic:crystal_shovel>                           :0.03 as float,
	<item:cyclic:quiver_damage>                            :0.03 as float,
	<item:cyclic:spell_water>							   :0.03 as float,
	<item:paraglider:spirit_orb>                           :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                       :0.03 as float
};
...
val village_loot as float[IItemStack] = {
	<item:aquaculture:box>                                 :0.025 as float,
	<item:aquaculture:lockbox>                             :0.025 as float,
	<item:aquaculture:treasure_chest>                      :0.025 as float,
	<item:artifacts:antidote_vessel>                       :0.025 as float,
	<item:artifacts:bunny_hoppers>                         :0.025 as float,
	<item:artifacts:cloud_in_a_bottle>                     :0.025 as float,
	<item:artifacts:cross_necklace>                        :0.025 as float,
	<item:artifacts:kitty_slippers>                        :0.025 as float,
	<item:artifacts:lucky_scarf>                           :0.025 as float,
	<item:artifacts:novelty_drinking_hat>                  :0.025 as float,
	<item:artifacts:panic_necklace>                        :0.025 as float,
	<item:artifacts:running_shoes>                         :0.025 as float,
	<item:artifacts:superstitious_hat>                     :0.025 as float,
	<item:artifacts:thorn_pendant>                         :0.025 as float,
	<item:artifacts:umbrella>                              :0.025 as float,
	<item:artifacts:universal_attractor>                   :0.025 as float,
	<item:artifacts:vampiric_glove>                        :0.025 as float,
	<item:artifacts:villager_hat>                          :0.025 as float,
	<item:artifacts:whoopee_cushion>                       :0.025 as float,
	<item:cyclic:charm_stealthpotion>                      :0.025 as float,
	<item:cyclic:crystal_hoe>                              :0.025 as float,
	<item:paraglider:spirit_orb>                           :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                       :0.025 as float
};
...
val desert_loot as float[IItemStack] = {
	<item:aquaculture:box>                                                :0.02 as float,
	<item:aquaculture:lockbox>                                            :0.02 as float,
	<item:aquaculture:treasure_chest>                                     :0.02 as float,
	<item:artifacts:bunny_hoppers>                                        :0.02 as float,
	<item:artifacts:cross_necklace>                                       :0.02 as float,
	<item:artifacts:digging_claws>                                        :0.02 as float,
	<item:artifacts:feral_claws>                                          :0.02 as float,
	<item:artifacts:fire_gauntlet>                                        :0.02 as float,
	<item:artifacts:flame_pendant>                                        :0.02 as float,
	<item:artifacts:lucky_scarf>                                          :0.02 as float,
	<item:artifacts:novelty_drinking_hat>                                 :0.02 as float,
	<item:artifacts:obsidian_skull>                                       :0.02 as float,
	<item:artifacts:panic_necklace>                                       :0.02 as float,
	<item:artifacts:pocket_piston>                                        :0.02 as float,
	<item:artifacts:power_glove>                                          :0.02 as float,
	<item:artifacts:running_shoes>                                        :0.02 as float,
	<item:artifacts:scarf_of_invisibility>                                :0.02 as float,
	<item:artifacts:steadfast_spikes>                                     :0.02 as float,
	<item:artifacts:vampiric_glove>                                       :0.02 as float,
	<item:cyclic:charm_creeper>                                           :0.02 as float,
	<item:cyclic:charm_fire>                                              :0.02 as float,
	<item:cyclic:charm_invisible>                                         :0.02 as float,
	<item:cyclic:charm_knockback_resistance>                              :0.02 as float,
	<item:cyclic:charm_longfall>                                          :0.02 as float,
	<item:cyclic:charm_magicdefense>                                      :0.02 as float,
	<item:cyclic:charm_speed>                                             :0.02 as float,
	<item:cyclic:charm_stealthpotion>                                     :0.02 as float,
	<item:cyclic:charm_venom>                                             :0.02 as float,
	<item:cyclic:charm_wing>                                              :0.02 as float,
	<item:cyclic:charm_world>                                             :0.02 as float,
	<item:cyclic:charm_xp_blocker>                                        :0.02 as float,
	<item:cyclic:charm_xp_speed>                                          :0.02 as float,
	<item:cyclic:crystal_pickaxe>                                         :0.02 as float,
	<item:cyclic:crystal_shovel>                                          :0.02 as float,
	<item:cyclic:crystal_sword>                                           :0.02 as float,
	<item:cyclic:ender_eye_reuse>                                         :0.02 as float,
	<item:cyclic:spawner_seeker>                                          :0.02 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string}) :0.02 as float,
	<item:paraglider:spirit_orb>                                          :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                                      :0.02 as float
};
...
val forest_loot as float[IItemStack] = {
	...
	<item:aquaculture:treasure_chest>                                      :0.025 as float,
	<item:artifacts:antidote_vessel>                                       :0.025 as float,
	<item:artifacts:feral_claws>                                           :0.025 as float,
	<item:artifacts:lucky_scarf>                                           :0.025 as float,
	<item:artifacts:panic_necklace>                                        :0.025 as float,
	<item:artifacts:pocket_piston>                                         :0.025 as float,
	<item:artifacts:running_shoes>                                         :0.025 as float,
	<item:artifacts:steadfast_spikes>                                      :0.025 as float,
	<item:artifacts:superstitious_hat>                                     :0.025 as float,
	<item:artifacts:thorn_pendant>                                         :0.025 as float,
	<item:artifacts:umbrella>                                              :0.025 as float,
	<item:artifacts:villager_hat>                                          :0.025 as float,
	<item:blue_skies:nature_key>                                           :0.025 as float,
	<item:cyclic:charm_antidote>                                           :0.025 as float,
	<item:cyclic:charm_attack_speed>                                       :0.025 as float,
	<item:cyclic:charm_creeper>                                            :0.025 as float,
	<item:cyclic:charm_home>                                               :0.025 as float,
	<item:cyclic:charm_longfall>                                           :0.025 as float,
	<item:cyclic:charm_speed>                                              :0.025 as float,
	<item:cyclic:charm_stealthpotion>                                      :0.025 as float,
	<item:cyclic:charm_wing>                                               :0.025 as float,
	<item:cyclic:crystal_axe>                                              :0.025 as float,
	<item:cyclic:crystal_hoe>                                              :0.025 as float,
	<item:cyclic:crystal_shovel>                                           :0.025 as float,
	<item:cyclic:quiver_damage>                                            :0.025 as float,
	<item:cyclic:spawner_seeker>                                           :0.025 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string})  :0.025 as float,
	<item:paraglider:spirit_orb>                                           :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                                       :0.025 as float
};
...
val frozen_loot as float[IItemStack] = {
	...
	<item:aquaculture:lockbox>                             :0.03 as float,
	<item:aquaculture:treasure_chest>                      :0.03 as float,
	<item:artifacts:aqua_dashers>                          :0.03 as float,
	<item:artifacts:bunny_hoppers>                         :0.03 as float,
	<item:artifacts:charm_of_sinking>                      :0.03 as float,
	<item:artifacts:cross_necklace>                        :0.03 as float,
	<item:artifacts:digging_claws>                         :0.03 as float,
	<item:artifacts:feral_claws>                           :0.03 as float,
	<item:artifacts:flippers>                              :0.03 as float,
	<item:artifacts:golden_hook>                           :0.03 as float,
	<item:artifacts:helium_flamingo>                       :0.03 as float,
	<item:artifacts:panic_necklace>                        :0.03 as float,
	<item:artifacts:scarf_of_invisibility>                 :0.03 as float,
	<item:artifacts:shock_pendant>                         :0.03 as float,
	<item:artifacts:snorkel>                               :0.03 as float,
	<item:artifacts:steadfast_spikes>                      :0.03 as float,
	<item:artifacts:umbrella>                              :0.03 as float,
	<item:artifacts:universal_attractor>                   :0.03 as float,
	<item:blue_skies:blinding_key>                         :0.03 as float,
	<item:cyclic:charm_speed>                              :0.03 as float,
	<item:cyclic:charm_stealthpotion>                      :0.03 as float,
	<item:cyclic:charm_water>                              :0.03 as float,
	<item:cyclic:crystal_axe>                              :0.03 as float,
	<item:cyclic:crystal_pickaxe>                          :0.03 as float,
	<item:cyclic:crystal_shovel>                           :0.03 as float,
	<item:cyclic:glove_climb>                              :0.03 as float,
	<item:cyclic:spawner_seeker>                           :0.03 as float,
	<item:paraglider:spirit_orb>                           :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                       :0.03 as float
};
...
val nether_loot as float[IItemStack] = {
	...
	<item:aquaculture:lockbox>                                             :0.02 as float,
	<item:aquaculture:treasure_chest>                                      :0.02 as float,
	<item:artifacts:cloud_in_a_bottle>                                     :0.02 as float,
	<item:artifacts:cross_necklace>                                        :0.02 as float,
	<item:artifacts:fire_gauntlet>                                         :0.02 as float,
	<item:artifacts:flame_pendant>                                         :0.02 as float,
	<item:artifacts:lucky_scarf>                                           :0.02 as float,
	...
	<item:artifacts:scarf_of_invisibility>                                 :0.02 as float,
	<item:artifacts:steadfast_spikes>                                      :0.02 as float,
	<item:artifacts:umbrella>                                              :0.02 as float,
	<item:artifacts:universal_attractor>                                   :0.02 as float,
	<item:artifacts:vampiric_glove>                                        :0.02 as float,
	<item:blue_skies:poison_key>                                           :0.02 as float,
	<item:cyclic:charm_attack_speed>                                       :0.02 as float,
	<item:cyclic:charm_boostpotion>                                        :0.02 as float,
	<item:cyclic:charm_creeper>                                            :0.02 as float,
	<item:cyclic:charm_crit>                                               :0.02 as float,
	<item:cyclic:charm_fire>                                               :0.02 as float,
	<item:cyclic:charm_invisible>                                          :0.02 as float,
	<item:cyclic:charm_knockback_resistance>                               :0.02 as float,
	<item:cyclic:charm_longfall>                                           :0.02 as float,
	...
	<item:cyclic:charm_speed>                                              :0.02 as float,
	<item:cyclic:charm_stealthpotion>                                      :0.02 as float,
	<item:cyclic:charm_ultimate>                                           :0.02 as float,
	<item:cyclic:charm_wing>                                               :0.02 as float,
	<item:cyclic:charm_wither>                                             :0.02 as float,
	<item:cyclic:charm_world>                                              :0.02 as float,
	<item:cyclic:crystal_axe>                                              :0.02 as float,
	<item:cyclic:crystal_pickaxe>                                          :0.02 as float,
	<item:cyclic:crystal_sword>                                            :0.02 as float,
	<item:cyclic:ender_eye_reuse>                                          :0.02 as float,
	<item:cyclic:ender_pearl_reuse>                                        :0.02 as float,
	<item:cyclic:glove_climb>                                              :0.02 as float,
	<item:cyclic:quiver_lightning>                                         :0.02 as float,
	<item:cyclic:spawner_seeker>                                           :0.02 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string})  :0.02 as float,
	<item:paraglider:spirit_orb>                                           :0.1 as float,
	<item:schoolsofmagic:letter_ccw>                                       :0.02 as float
...
val end_loot as float[IItemStack] = {
	...
	<item:artifacts:power_glove>                                          :0.02 as float,
	<item:artifacts:scarf_of_invisibility>                                :0.02 as float,
	<item:artifacts:shock_pendant>                                        :0.02 as float,
	<item:artifacts:universal_attractor>                                  :0.02 as float,
	<item:blue_skies:poison_key>                                          :0.02 as float,
	<item:cyclic:antigravity>                                             :0.02 as float,
	<item:cyclic:charm_attack_speed>                                      :0.02 as float,
	<item:cyclic:charm_boostpotion>                                       :0.02 as float,
	<item:cyclic:charm_creeper>                                           :0.02 as float,
	<item:cyclic:charm_crit>                                              :0.02 as float,
	<item:cyclic:charm_home>                                              :0.02 as float,
	<item:cyclic:charm_invisible>                                         :0.02 as float,
	<item:cyclic:charm_knockback_resistance>                              :0.02 as float,
	<item:cyclic:charm_longfall>                                          :0.02 as float,
	<item:cyclic:charm_magicdefense>                                      :0.02 as float,
	<item:cyclic:charm_speed>                                             :0.02 as float,
	<item:cyclic:charm_starvation>                                        :0.02 as float,
	<item:cyclic:charm_stealthpotion>                                     :0.02 as float,
	<item:cyclic:charm_stone>                                             :0.02 as float,
	<item:cyclic:charm_ultimate>                                          :0.02 as float,
	<item:cyclic:charm_venom>                                             :0.02 as float,
	<item:cyclic:charm_void>                                              :0.02 as float,
	<item:cyclic:charm_wing>                                              :0.02 as float,
	<item:cyclic:charm_world>                                             :0.02 as float,
	<item:cyclic:charm_xp_speed>                                          :0.02 as float,
	<item:cyclic:crystal_pickaxe>                                         :0.02 as float,
	<item:cyclic:crystal_sword>                                           :0.02 as float,
	<item:cyclic:elevation_wand>                                          :0.02 as float,
	<item:cyclic:ender_bag>                                               :0.02 as float,
	<item:cyclic:ender_book>                                              :0.02 as float,
	<item:cyclic:ender_pearl_mounted>                                     :0.02 as float,
	<item:cyclic:ender_pearl_reuse>                                       :0.02 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string}) :0.02 as float,
	<item:paraglider:spirit_orb>                                          :0.1 as float,
	<item:quark:diamond_heart>                                            :0.02 as float,
	<item:schoolsofmagic:letter_ccw>                                      :0.02 as float
};
...
val treasure_loot as float[IItemStack] = {
	<item:aquaculture:box>                                                 :0.005 as float,
	<item:aquaculture:lockbox>                                             :0.005 as float,
	<item:aquaculture:treasure_chest>                                      :0.005 as float,
	<item:artifacts:antidote_vessel>                                       :0.005 as float,
	<item:artifacts:aqua_dashers>                                          :0.005 as float,
	<item:artifacts:bunny_hoppers>                                         :0.005 as float,
	<item:artifacts:charm_of_sinking>                                      :0.005 as float,
	<item:artifacts:cloud_in_a_bottle>                                     :0.005 as float,
	<item:artifacts:cross_necklace>                                        :0.005 as float,
	<item:artifacts:digging_claws>                                         :0.005 as float,
	<item:artifacts:feral_claws>                                           :0.005 as float,
	<item:artifacts:fire_gauntlet>                                         :0.005 as float,
	<item:artifacts:flame_pendant>                                         :0.005 as float,
	<item:artifacts:flippers>                                              :0.005 as float,
	<item:artifacts:golden_hook>                                           :0.005 as float,
	<item:artifacts:helium_flamingo>                                       :0.005 as float,
	<item:artifacts:kitty_slippers>                                        :0.005 as float,
	<item:artifacts:lucky_scarf>                                           :0.005 as float,
	<item:artifacts:night_vision_goggles>                                  :0.005 as float,
	<item:artifacts:novelty_drinking_hat>                                  :0.005 as float,
	<item:artifacts:obsidian_skull>                                        :0.005 as float,
	<item:artifacts:panic_necklace>                                        :0.005 as float,
	<item:artifacts:plastic_drinking_hat>                                  :0.005 as float,
	<item:artifacts:pocket_piston>                                         :0.005 as float,
	<item:artifacts:power_glove>                                           :0.005 as float,
	<item:artifacts:running_shoes>                                         :0.005 as float,
	<item:artifacts:scarf_of_invisibility>                                 :0.005 as float,
	<item:artifacts:shock_pendant>                                         :0.005 as float,
	<item:artifacts:snorkel>                                               :0.005 as float,
	<item:artifacts:steadfast_spikes>                                      :0.005 as float,
	<item:artifacts:superstitious_hat>                                     :0.005 as float,
	<item:artifacts:thorn_pendant>                                         :0.005 as float,
	<item:artifacts:umbrella>                                              :0.005 as float,
	<item:artifacts:universal_attractor>                                   :0.005 as float,
	<item:artifacts:vampiric_glove>                                        :0.005 as float,
	<item:artifacts:villager_hat>                                          :0.005 as float,
	<item:artifacts:whoopee_cushion>                                       :0.005 as float,
	<item:blue_skies:blinding_key>                                         :0.005 as float,
	<item:blue_skies:nature_key>                                           :0.005 as float,
	<item:blue_skies:poison_key>                                           :0.005 as float,
	<item:cyclic:antigravity>                                              :0.005 as float,
	<item:cyclic:boomerang_stun>                                           :0.005 as float,
	<item:cyclic:charm_antidote>                                           :0.005 as float,
	<item:cyclic:charm_attack_speed>                                       :0.005 as float,
	<item:cyclic:charm_boostpotion>                                        :0.005 as float,
	<item:cyclic:charm_creeper>                                            :0.005 as float,
	<item:cyclic:charm_crit>                                               :0.005 as float,
	<item:cyclic:charm_fire>                                               :0.005 as float,
	<item:cyclic:charm_home>                                               :0.005 as float,
	<item:cyclic:charm_invisible>                                          :0.005 as float,
	<item:cyclic:charm_knockback_resistance>                               :0.005 as float,
	<item:cyclic:charm_longfall>                                           :0.005 as float,
	<item:cyclic:charm_magicdefense>                                       :0.005 as float,
	<item:cyclic:charm_speed>                                              :0.005 as float,
	<item:cyclic:charm_starvation>                                         :0.005 as float,
	<item:cyclic:charm_stealthpotion>                                      :0.005 as float,
	<item:cyclic:charm_stone>                                              :0.005 as float,
	<item:cyclic:charm_ultimate>                                           :0.001 as float,
	<item:cyclic:charm_venom>                                              :0.005 as float,
	<item:cyclic:charm_void>                                               :0.005 as float,
	<item:cyclic:charm_water>                                              :0.005 as float,
	<item:cyclic:charm_wing>                                               :0.005 as float,
	<item:cyclic:charm_wither>                                             :0.005 as float,
	<item:cyclic:charm_world>                                              :0.005 as float,
	<item:cyclic:charm_xp_blocker>                                         :0.005 as float,
	<item:cyclic:charm_xp_speed>                                           :0.005 as float,
	<item:cyclic:crystal_axe>                                              :0.005 as float,
	<item:cyclic:crystal_hoe>                                              :0.005 as float,
	<item:cyclic:crystal_pickaxe>                                          :0.005 as float,
	<item:cyclic:crystal_shovel>                                           :0.005 as float,
	<item:cyclic:crystal_sword>                                            :0.005 as float,
	<item:cyclic:elevation_wand>										   :0.005 as float,
	<item:cyclic:ender_bag>                                                :0.005 as float,
	<item:cyclic:ender_book>                                               :0.005 as float,
	<item:cyclic:ender_eye_reuse>                                          :0.005 as float,
	<item:cyclic:ender_pearl_mounted>                                      :0.005 as float,
	<item:cyclic:ender_pearl_reuse>                                        :0.005 as float,
	<item:cyclic:glove_climb>                                              :0.005 as float,
	<item:cyclic:prospector>                                               :0.005 as float,
	<item:cyclic:quiver_damage>                                            :0.005 as float,
	<item:cyclic:quiver_lightning>                                         :0.005 as float,
	<item:cyclic:spawner_seeker>                                           :0.005 as float,
	<item:minecraft:potion>.withTag({Potion: "minecraft:luck" as string})  :0.005 as float,
	<item:paraglider:spirit_orb>                                           :0.1 as float,
	<item:quark:diamond_heart>                                             :0.005 as float,
	<item:schoolsofmagic:letter_ccw>                                       :0.005 as float
};
