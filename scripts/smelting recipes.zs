...
val dust_to_ingot_map as IItemStack[IIngredient] = {
	...
	<tag:items:create:crushed_ores/aluminum>.asIIngredient(): <item:immersiveengineering:ingot_aluminum>,
	...
	<tag:items:create:crushed_ores/uranium>.asIIngredient(): <item:immersiveengineering:ingot_uranium>,
	...
	<tag:items:create:crushed_ores/nickel>.asIIngredient(): <item:immersiveengineering:ingot_nickel>,
	...
	<tag:items:create:crushed_ores/lead>.asIIngredient(): <item:immersiveengineering:ingot_lead>,
	...
	<tag:items:create:crushed_ores/silver>: <item:immersiveengineering:ingot_silver>,
	...
	<tag:items:create:crushed_ores/tin>.asIIngredient(): <item:ftbic:tin_ingot>,
