...
val dust_to_ingot_map as IItemStack[IIngredient] = {
	...
	<tag:items:forge:dusts/iron>.asIIngredient(): <item:minecraft:iron_ingot>,
	...
	<tag:items:forge:dusts/aluminum>.asIIngredient(): <item:immersiveengineering:ingot_aluminum>,
	...
	<tag:items:forge:dusts/gold>.asIIngredient(): <item:minecraft:gold_ingot>,
	...
	<tag:items:forge:dusts/uranium>.asIIngredient(): <item:immersiveengineering:ingot_uranium>,
	...
	<tag:items:forge:dusts/nickel>.asIIngredient(): <item:immersiveengineering:ingot_nickel>,
	...
	<tag:items:forge:dusts/lead>.asIIngredient(): <item:immersiveengineering:ingot_lead>,
	...
	<tag:items:forge:dusts/silver>.asIIngredient(): <item:immersiveengineering:ingot_silver>,
	...
	<tag:items:forge:dusts/copper>.asIIngredient(): <item:minecraft:copper_ingot>,
	<tag:items:forge:raw_materials/tin>.asIIngredient(): <item:ftbic:tin_ingot>,
	<item:create:crushed_tin_ore>: <item:ftbic:tin_ingot>,
	<tag:items:forge:dusts/tin>.asIIngredient(): <item:ftbic:tin_ingot>,
	...
	<tag:items:forge:dusts/cobalt>.asIIngredient(): <item:tconstruct:cobalt_ingot>,
	...
	<tag:items:forge:dusts/zinc>.asIIngredient(): <item:create:zinc_ingot>,
	...
	<tag:items:forge:dusts/cloggrum>.asIIngredient(): <item:undergarden:cloggrum_ingot>,
