...
mods.extendedcrafting.TableCrafting.addShaped("8e5e468c-cd14-44f1-b4dc-dee42e7ca96a", 0, <item:contenttweaker:limitless_potential_core>, [
	...
	[<item:minecraft:shulker_shell>, <item:byg:ametrine_gems>, <item:bloodmagic:etherealslate>, <item:infernalexp:molten_gold_cluster>, <item:crittersandcompanions:pearl>, <item:infernalexp:molten_gold_cluster>, <item:bloodmagic:etherealslate>, <item:byg:ametrine_gems>, <item:minecraft:shulker_shell>], 
	[<item:byg:ametrine_gems>, <item:bloodmagic:etherealslate>, <item:paraglider:spirit_orb>, <item:create:precision_mechanism>, <item:botania:life_essence>, <item:create:precision_mechanism>, <item:paraglider:spirit_orb>, <item:bloodmagic:etherealslate>, <item:byg:ametrine_gems>], 
